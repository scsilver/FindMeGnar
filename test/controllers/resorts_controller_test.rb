...
class ResortsControllerTest < ActionController::TestCase
  ...
  test "should create resort" do
    assert_difference('Resort.count') do
      post :create, resort: { base: @resort.base, gnarlocity: @resort.gnarlocity, name: @resort.name, snowfall: @resort.snowfall, temp: @resort.temp }
    end
  ...
  test "should update resort" do
    patch :update, id: @resort, resort: { base: @resort.base, gnarlocity: @resort.gnarlocity, name: @resort.name, snowfall: @resort.snowfall, temp: @resort.temp }
    assert_redirected_to resort_path(assigns(:resort))
  end
